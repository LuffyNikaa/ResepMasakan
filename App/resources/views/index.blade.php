  ...
  <body>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-slide="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Image/image/14.bubur_ayam.jpg" class="d-block w-100" alt="...">
          ...
          <div class="carousel-item">
            <img src="Image/image/2.ayam_cabe.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="Image/image/3.sate_kulitayam.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
    ...
    <div class="gallery">
      <div class="gallery-item">
          <img src="Image/image/10.ayam_gorangtepung.jpg" alt="Gambar 1">
          <div class="caption">Keterangan Gambar 1</div>
      </div>
      <div class="gallery-item">
          <img src="Image/image/11.sop_ayambening.jpg" alt="Gambar 2">
          <div class="caption">Keterangan Gambar 2</div>
      </div>
      <div class="gallery-item">
          <img src="Image/image/15.martabak_mie.png" alt="Gambar 3">
          <div class="caption">Keterangan Gambar 3</div>
      </div>
